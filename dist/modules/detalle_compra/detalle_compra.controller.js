...
exports.eliminar = exports.actualizar = exports.crear = exports.obtenerPorCompra = exports.obtenerPorId = exports.obtenerTodos = void 0;
const service = __importStar(require("./detalle_compra.service"));
const zod_1 = require("zod");
const detalle_compra_schema_1 = require("./detalle_compra.schema");
...
const obtenerPorId = async (req, res) => {
    try {
        ...
        const { id: validatedId } = detalle_compra_schema_1.detalleIdSchema.parse({ id });
...
const obtenerPorCompra = async (req, res) => {
    try {
        const rawId = Array.isArray(req.params.id) ? req.params.id[0] : req.params.id;
        const id = parseInt(rawId);
        if (isNaN(id)) {
...
exports.obtenerPorCompra = obtenerPorCompra;
const crear = async (req, res) => {
    try {
        console.log('crear req.body:', req.body);
        const validatedData = detalle_compra_schema_1.createDetalleCompraSchema.parse(req.body);
...
const actualizar = async (req, res) => {
    try {
        ...
        const validatedData = detalle_compra_schema_1.updateDetalleCompraSchema.parse(req.body);
