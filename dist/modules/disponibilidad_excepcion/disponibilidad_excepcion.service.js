...
const repository = __importStar(require("./disponibilidad_excepcion.repository"));
const getAllDisponibilidades = async () => await repository.getAllDisponibilidades();
exports.getAllDisponibilidades = getAllDisponibilidades;
const getDisponibilidadById = async (id) => await repository.getDisponibilidadById(id);
