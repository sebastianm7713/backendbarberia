...
exports.obtenerCitaConVenta = exports.marcarNotificado = exports.cambiarEstado = exports.listarCitas = exports.crearCita = void 0;
    ...
    try {
      ...
      `);
        ...
        `);
            ...
            const ganancia_barbero = (subtotal * servicio.porcentaje_barbero) / 100;
            // Generar factura
