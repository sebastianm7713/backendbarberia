...
exports.pagosRealizadosRepository = exports.PagosRealizadosRepository = void 0;
const mssql_1 = __importDefault(require("mssql"));
const database_1 = require("../../config/database");
class PagosRealizadosRepository {
    ...
    `;
        if (estado_pago) {
            request.input("estado_pago", mssql_1.default.VarChar(50), estado_pago);
    ...
    async createPago(id_compra, monto_pagado, fecha_pago, metodo_pago, referencia) {
        const request = database_1.pool.request();
    ...
    `);
        ...
        request.input("id_pago", mssql_1.default.Int, id_pago);
        request.input("id_compra", mssql_1.default.Int, id_compra);
    ...
    async updatePago(id_pago, updateData) {
        ...
        if (updates.length === 0) {
            const result = await request.query("SELECT * FROM Pagos_Realizados WHERE id_pago = @id_pago");
            return result.recordset[0];
        }
        query += updates.join(", ");
...
exports.PagosRealizadosRepository = PagosRealizadosRepository;
exports.pagosRealizadosRepository = new PagosRealizadosRepository();
