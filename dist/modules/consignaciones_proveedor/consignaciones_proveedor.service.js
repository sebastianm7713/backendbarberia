...
const repository = __importStar(require("./consignaciones_proveedor.repository"));
const getAllConsignaciones = async () => await repository.getAllConsignaciones();
exports.getAllConsignaciones = getAllConsignaciones;
const getConsignacionById = async (id) => await repository.getConsignacionById(id);
